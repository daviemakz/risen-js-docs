  ...
  render() {
    ...
    const FeatureCallout = () => (
      ...
      >
        ...
        <MarkdownBlock>
          Out of the box support for the latest ECMA+ features and full access to all NPM packages allows you to build flexible, high performance and modern applications.
        </MarkdownBlock>
      </div>
    );
